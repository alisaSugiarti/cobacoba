...
filenameModelKnn = 'modelKnn.joblib'
...
filenameModelGau = 'modelGauNB.joblib'
...
filenameModelDT = 'modelDT.joblib'
...
filenameModelrmf = 'modelrmf.joblib'
...
with K_Nearest_Naighbour:
    ...
    filenameModelKnnNorm = 'modelKnn.joblib'
